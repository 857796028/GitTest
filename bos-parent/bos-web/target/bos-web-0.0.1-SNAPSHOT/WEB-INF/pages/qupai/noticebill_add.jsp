			...
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					...
					<td><input type="text" class="easyui-validatebox" name="telephone" required="true" />
						<script type="text/javascript">
						  $(function(){
						  //页面加载完成后,为来电号码 输入框绑定离焦事件
						    $("input[name=telephone]").blur(function(){
						    	var telephone = this.value;  //获取到输入的手机号
						    	//alert(telephone);  尝试打印输入的内容
						    	//发送ajax请求,请求action,在action中调用远程crm服务  用来桌面回显
						    	$.post( 'noticebillAction_findCustomerByTelephone.action',
						    		{"telephone":telephone},
						    		function(data){
						    		  //alert(data);	
						    		  if(data != null){//查询到了客户信息,可以进行页面回显
