...
<script type="text/javascript">
	...
	$(function() {
		...
		//当点击修改密码的时候 弹出确定的选项 此处是为了绑定事件
		$("#btnEp").click(function(){
			//alert("修改密码");
			//需要进行表单校验 1.添加Form标签
	        var v = $("#editPasswordForm").form("validate");  //此处是为了 一点击确认 就会弹出非空校验的提示框
			//alert(v);
    ...
    <div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true" closed="true" resizable="false"
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <form id="editPasswordForm"> <!-- 此处添加form是为了进行校验 -->
		                <table cellpadding=3>
		                    <tr>
		                        <td>新密码：</td>
		                        <td><input   data-options="validType:'length[4,6]'" required="true" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
		                    </tr>
		                    <tr>
		                        <td>确认密码：</td>
		                        <td><input  data-options="validType:'length[4,6]'" required="true" id="txtRePass" type="Password"  class="txt01 easyui-validatebox" /></td>
		                    </tr>
                         </table>
                </form>
            </div>
